...
import com.example.bibishop.sanpham.repository.ChatLieuRepository;
...
public class ChatLieuIMPL implements ChatLieuService {
    ...
    public ChatLieuDTO addChatLieu(ChatLieuDTO chatLieuDTO) {
        ChatLieuEntity chatLieu = ChatLieuEntity.builder()
                ...
                .trangThai(chatLieuDTO.getTrangThai() != null ? chatLieuDTO.getTrangThai() : 1) // Kiểm tra trạng thái, nếu null thì mặc định là 1
                .build();
